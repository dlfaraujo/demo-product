...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6372073665788700846L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"io.confluent.demo.pojo.avro\",\"fields\":[{\"name\":\"product_id\",\"type\":\"long\"},{\"name\":\"product_name\",\"type\":\"string\"},{\"name\":\"product_price\",\"type\":\"double\"}]}");
   ...
   */
  public static io.confluent.demo.pojo.avro.Product.Builder newBuilder() {
    return new io.confluent.demo.pojo.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static io.confluent.demo.pojo.avro.Product.Builder newBuilder(io.confluent.demo.pojo.avro.Product.Builder other) {
    if (other == null) {
      return new io.confluent.demo.pojo.avro.Product.Builder();
    } else {
      return new io.confluent.demo.pojo.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static io.confluent.demo.pojo.avro.Product.Builder newBuilder(io.confluent.demo.pojo.avro.Product other) {
    if (other == null) {
      return new io.confluent.demo.pojo.avro.Product.Builder();
    } else {
      return new io.confluent.demo.pojo.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.demo.pojo.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.demo.pojo.avro.Product other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Product.Builder setProductId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Product.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Product.Builder setProductName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Product.Builder clearProductName() {
      product_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Product.Builder setProductPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Product.Builder clearProductPrice() {
