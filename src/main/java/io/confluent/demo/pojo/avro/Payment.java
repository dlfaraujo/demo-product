...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3863172660304803069L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"io.confluent.demo.pojo.avro\",\"fields\":[{\"name\":\"payment_method_code\",\"type\":\"int\"},{\"name\":\"card_number\",\"type\":\"long\"},{\"name\":\"expiration_date\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"00/00\"},{\"name\":\"cvv\",\"type\":\"int\"}]}");
   ...
   */
  public Payment(java.lang.Integer payment_method_code, java.lang.Long card_number, java.lang.String expiration_date, java.lang.Integer cvv) {
   ...
   */
  public static io.confluent.demo.pojo.avro.Payment.Builder newBuilder() {
    return new io.confluent.demo.pojo.avro.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static io.confluent.demo.pojo.avro.Payment.Builder newBuilder(io.confluent.demo.pojo.avro.Payment.Builder other) {
    if (other == null) {
      return new io.confluent.demo.pojo.avro.Payment.Builder();
    } else {
      return new io.confluent.demo.pojo.avro.Payment.Builder(other);
    }
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static io.confluent.demo.pojo.avro.Payment.Builder newBuilder(io.confluent.demo.pojo.avro.Payment other) {
    if (other == null) {
      return new io.confluent.demo.pojo.avro.Payment.Builder();
    } else {
      return new io.confluent.demo.pojo.avro.Payment.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.demo.pojo.avro.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.demo.pojo.avro.Payment other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.payment_method_code)) {
        this.payment_method_code = data().deepCopy(fields()[0].schema(), other.payment_method_code);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder setPaymentMethodCode(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder clearPaymentMethodCode() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder setCardNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder clearCardNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder setExpirationDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder clearExpirationDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder setCvv(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Payment.Builder clearCvv() {
