...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6896668954352029058L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"io.confluent.demo.pojo.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":\"long\",\"doc\":\"The id of the order.\"},{\"name\":\"order_date\",\"type\":\"long\",\"logicalType\":\"date\"},{\"name\":\"order_amount\",\"type\":\"double\"},{\"name\":\"products\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Product\",\"fields\":[{\"name\":\"product_id\",\"type\":\"long\"},{\"name\":\"product_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"product_price\",\"type\":\"double\"}]}}},{\"name\":\"customer\",\"type\":{\"type\":\"record\",\"name\":\"Customer\",\"fields\":[{\"name\":\"customer_id\",\"type\":\"long\"},{\"name\":\"customer_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customer_email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customer_address\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}},{\"name\":\"payment_method\",\"type\":{\"type\":\"record\",\"name\":\"Payment\",\"fields\":[{\"name\":\"payment_method_code\",\"type\":\"int\"},{\"name\":\"card_number\",\"type\":\"long\"},{\"name\":\"expiration_date\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"00/00\"},{\"name\":\"cvv\",\"type\":\"int\"}]}}]}");
  ...
  @Deprecated public java.util.List<io.confluent.demo.pojo.avro.Product> products;
  @Deprecated public io.confluent.demo.pojo.avro.Customer customer;
  @Deprecated public io.confluent.demo.pojo.avro.Payment payment_method;
   ...
   */
  public Order(java.lang.Long order_id, java.lang.Long order_date, java.lang.Double order_amount, java.util.List<io.confluent.demo.pojo.avro.Product> products, io.confluent.demo.pojo.avro.Customer customer, io.confluent.demo.pojo.avro.Payment payment_method) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: products = (java.util.List<io.confluent.demo.pojo.avro.Product>)value$; break;
    case 4: customer = (io.confluent.demo.pojo.avro.Customer)value$; break;
    case 5: payment_method = (io.confluent.demo.pojo.avro.Payment)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<io.confluent.demo.pojo.avro.Product> getProducts() {
    return products;
  }
   ...
   * @param value the value to set.
   */
  public void setProducts(java.util.List<io.confluent.demo.pojo.avro.Product> value) {
    this.products = value;
  }
   ...
   */
  public io.confluent.demo.pojo.avro.Customer getCustomer() {
    return customer;
  }
   ...
   * @param value the value to set.
   */
  public void setCustomer(io.confluent.demo.pojo.avro.Customer value) {
    this.customer = value;
  }
   ...
   */
  public io.confluent.demo.pojo.avro.Payment getPaymentMethod() {
   ...
   * @param value the value to set.
   */
  public void setPaymentMethod(io.confluent.demo.pojo.avro.Payment value) {
   ...
   */
  public static io.confluent.demo.pojo.avro.Order.Builder newBuilder() {
    return new io.confluent.demo.pojo.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static io.confluent.demo.pojo.avro.Order.Builder newBuilder(io.confluent.demo.pojo.avro.Order.Builder other) {
    if (other == null) {
      return new io.confluent.demo.pojo.avro.Order.Builder();
    } else {
      return new io.confluent.demo.pojo.avro.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static io.confluent.demo.pojo.avro.Order.Builder newBuilder(io.confluent.demo.pojo.avro.Order other) {
    if (other == null) {
      return new io.confluent.demo.pojo.avro.Order.Builder();
    } else {
      return new io.confluent.demo.pojo.avro.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
    ...
    private java.util.List<io.confluent.demo.pojo.avro.Product> products;
    private io.confluent.demo.pojo.avro.Customer customer;
    private io.confluent.demo.pojo.avro.Customer.Builder customerBuilder;
    private io.confluent.demo.pojo.avro.Payment payment_method;
    private io.confluent.demo.pojo.avro.Payment.Builder payment_methodBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.demo.pojo.avro.Order.Builder other) {
      super(other);
      ...
      if (other.hasCustomerBuilder()) {
        this.customerBuilder = io.confluent.demo.pojo.avro.Customer.newBuilder(other.getCustomerBuilder());
      }
      ...
      if (other.hasPaymentMethodBuilder()) {
        this.payment_methodBuilder = io.confluent.demo.pojo.avro.Payment.newBuilder(other.getPaymentMethodBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.demo.pojo.avro.Order other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder setOrderId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder clearOrderId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder setOrderDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder clearOrderDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder setOrderAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder clearOrderAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder setProducts(java.util.List<io.confluent.demo.pojo.avro.Product> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder clearProducts() {
      products = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder setCustomer(io.confluent.demo.pojo.avro.Customer value) {
     ...
     * @return This builder.
     */
    public io.confluent.demo.pojo.avro.Customer.Builder getCustomerBuilder() {
      if (customerBuilder == null) {
        if (hasCustomer()) {
          setCustomerBuilder(io.confluent.demo.pojo.avro.Customer.newBuilder(customer));
        } else {
          setCustomerBuilder(io.confluent.demo.pojo.avro.Customer.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public io.confluent.demo.pojo.avro.Order.Builder setCustomerBuilder(io.confluent.demo.pojo.avro.Customer.Builder value) {
      clearCustomer();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder clearCustomer() {
      customer = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder setPaymentMethod(io.confluent.demo.pojo.avro.Payment value) {
     ...
     * @return This builder.
     */
    public io.confluent.demo.pojo.avro.Payment.Builder getPaymentMethodBuilder() {
      if (payment_methodBuilder == null) {
        if (hasPaymentMethod()) {
          setPaymentMethodBuilder(io.confluent.demo.pojo.avro.Payment.newBuilder(payment_method));
        } else {
          setPaymentMethodBuilder(io.confluent.demo.pojo.avro.Payment.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public io.confluent.demo.pojo.avro.Order.Builder setPaymentMethodBuilder(io.confluent.demo.pojo.avro.Payment.Builder value) {
      clearPaymentMethod();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.demo.pojo.avro.Order.Builder clearPaymentMethod() {
      payment_method = null;
    ...
    public Order build() {
      try {
        ...
        record.products = fieldSetFlags()[3] ? this.products : (java.util.List<io.confluent.demo.pojo.avro.Product>) defaultValue(fields()[3]);
        if (customerBuilder != null) {
          try {
          ...
          record.customer = fieldSetFlags()[4] ? this.customer : (io.confluent.demo.pojo.avro.Customer) defaultValue(fields()[4]);
        }
        if (payment_methodBuilder != null) {
          try {
          ...
          record.payment_method = fieldSetFlags()[5] ? this.payment_method : (io.confluent.demo.pojo.avro.Payment) defaultValue(fields()[5]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (io.confluent.demo.pojo.avro.Product e0: this.products) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<io.confluent.demo.pojo.avro.Product> a0 = this.products;
      if (a0 == null) {
        a0 = new SpecificData.Array<io.confluent.demo.pojo.avro.Product>((int)size0, SCHEMA$.getField("products").schema());
        this.products = a0;
      } else a0.clear();
      SpecificData.Array<io.confluent.demo.pojo.avro.Product> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<io.confluent.demo.pojo.avro.Product>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          io.confluent.demo.pojo.avro.Product e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new io.confluent.demo.pojo.avro.Product();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
      ...
      if (this.customer == null) {
        this.customer = new io.confluent.demo.pojo.avro.Customer();
      }
      this.customer.customDecode(in);

      if (this.payment_method == null) {
        this.payment_method = new io.confluent.demo.pojo.avro.Payment();
      }
