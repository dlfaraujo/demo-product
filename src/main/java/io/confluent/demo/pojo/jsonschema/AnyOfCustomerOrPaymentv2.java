...
public class AnyOfCustomerOrPaymentv2 {
    ...
    public String toString() {
        ...
        sb.append(AnyOfCustomerOrPaymentv2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("anyOf");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AnyOfCustomerOrPaymentv2) == false) {
            return false;
        }
        AnyOfCustomerOrPaymentv2 rhs = ((AnyOfCustomerOrPaymentv2) other);
