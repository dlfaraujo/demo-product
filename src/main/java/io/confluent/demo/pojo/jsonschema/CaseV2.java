...
public class CaseV2 {
    ...
    private CaseV2 .ImmigrationStatus immigrationStatus;
    /**
     ...
     */
    @JsonProperty("immigrationStatus")
    public CaseV2 .ImmigrationStatus getImmigrationStatus() {
     ...
     */
    @JsonProperty("immigrationStatus")
    public void setImmigrationStatus(CaseV2 .ImmigrationStatus immigrationStatus) {
    ...
    public String toString() {
        ...
        sb.append(CaseV2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("caseId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaseV2) == false) {
            return false;
        }
        CaseV2 rhs = ((CaseV2) other);
    ...
    public enum ImmigrationStatus {
        ...
        private final static Map<String, CaseV2 .ImmigrationStatus> CONSTANTS = new HashMap<String, CaseV2 .ImmigrationStatus>();

        static {
            for (CaseV2 .ImmigrationStatus c: values()) {
        ...
        @JsonCreator
        public static CaseV2 .ImmigrationStatus fromValue(String value) {
            CaseV2 .ImmigrationStatus constant = CONSTANTS.get(value);
            if (constant == null) {
